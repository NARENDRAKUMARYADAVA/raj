...
@app.on_message(Filters.chat(-1001416872222) & Filters.text & ~ Filters.regex('👇'))
def forawrd(client, message):
    ...
    for line in lines:
      if line == "started": 
          client.forward_messages(-1001344956857, -1001416872222, [message.message_id], 'bool = None ', 'bool = True' , 'bool = True' )
          client.forward_messages(-1001356076506, -1001416872222, [message.message_id], 'bool = None ', 'bool = True' , 'bool = True' )
    for line in liner:
      if line == "started":
         client.forward_messages(-1001356076506, -1001416872222, [message.message_id], 'bool = None ', 'bool = True' , 'bool = True' )
